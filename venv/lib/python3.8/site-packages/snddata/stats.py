...
def timeparams_decorate(func):
    def func_wrapper(s, startframe=None, endframe=None, starttime=None,
                     ...
                     framesize=defaultframesize, *args, **kwargs):
        ...
        if framesize is None or (endframe - startframe) <= framesize:
            framesize = endframe
        return func(s, startframe=startframe, endframe=endframe,
                    framesize=framesize, *args, **kwargs)
...
def rms(s, startframe=None, endframe=None, starttime=None, endtime=None,
        startdatetime=None, enddatetime=None,
        framesize=defaultframesize, channelindex=slice(None), dtype=None):
    sqsum = 0.
    nframes = 0
    for ar in s.iterview_frames(blocklen=framesize, startframe=startframe,
                                endframe=endframe,
...
def max(s, startframe=None, endframe=None, starttime=None, endtime=None,
               startdatetime=None, enddatetime=None,
               framesize=defaultframesize, channelindex=slice(None)):
