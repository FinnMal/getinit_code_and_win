...
def makeRows(rows, cols, largestElementLength, rowLength, matrixToWorkOn, finalTable, color):
    ...
    for i in range(rows):
        ...
        for j in range(cols):
            ...
            if ((color != None) and (j == 0 or i == 0)):
                ...
                currentEl = " " + "\033[38;2;" + str(color[0]) + ";" + str(color[1]) + ";" + str(color[2]) + "m" + \
                            matrixToWorkOn[i][j] + "\033[0m"
            ...
            if (largestElementLength != len(matrixToWorkOn[i][j])):
                ...
                if (color != None):
                    if (j == 0 or i == 0):
                        currentEl = currentEl + " " * (largestElementLength - (len(currentEl) - len(
                            "\033[38;2;" + str(color[0]) + ";" + str(color[1]) + ";" + str(
                                color[2]) + "m" + "\033[0m")) + 2) + "|"
    ...
    if (color != None):
        rowLength = len(currentRow) - len(
            "\033[38;2;" + str(color[0]) + ";" + str(color[1]) + ";" + str(color[2]) + "m" + "\033[0m")
